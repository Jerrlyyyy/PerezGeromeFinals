...
const Updatesecondyear = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8081/bsitsecondyearlist/updatesecondyear/${id}`)
            .then((res) => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`http://localhost:8081/bsitsecondyearlist/updatesecondyear/${id}`, formData)
    .then(() => {
...
export default Updatesecondyear