...
const Updatethirdyear = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8081/bsitthirdyearlist/updatethirdyear/${id}`)
            .then((res) => {
    ...
    const handleSubmit = (event) => {
        event.preventDefault();
            ...
            axios.put(`http://localhost:8081/bsitthirdyearlist/updatethirdyear/${id}`, formData)
            .then(() => {
...
export default Updatethirdyear