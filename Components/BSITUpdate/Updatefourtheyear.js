...
const Updatefourtheyear = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8081/bsitfourthyearlist/updatefourthyear/${id}`)
            .then((res) => {
    ...
    const handleSubmit = (event) => {
        event.preventDefault();
            ...
            axios.put(`http://localhost:8081/bsitfourthyearlist/updatefourthyear/${id}`, formData)
            .then(() => {
...
export default Updatefourtheyear