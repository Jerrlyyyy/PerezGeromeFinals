...
const UpdateSecondyearBLIS = () => {
    ...
    const handleLogout = () => {
        navigate('/BLISsecondyearlist'); // Redirect to login page
    };

    useEffect(() => {
        axios.get(`http://localhost:8081/BLISsecondyearlist/updatesecondyearblis/${id}`)
            .then((res) => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`http://localhost:8081/BLISsecondyearlist/updatesecondyearblis/${id}`, formData)
    .then(() => {
...
export default UpdateSecondyearBLIS